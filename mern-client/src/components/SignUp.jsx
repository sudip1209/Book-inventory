...
const SignUp = () => {
  ...
  const [error, setError] = useState(null); // Corrected the destructuring here
        ...
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
          <div className="max-w-md mx-auto">
            <div>
              ...
              {/* Corrected from "sign in" to "Sign Up" */}
            </div>
            ...
            <div className="flex w-full item-center  flex-col mt-5 gap-3">
              <button onClick={handleRegister} className="inline-block">
                {" "}
                <img
                  src={googleLogo}
                  alt=""
